import 'package:ar_scan/freeze_button.dart';
import 'package:ar_scan/product_bubble.dart';
import 'package:ar_scan/quadrilateral_extension.dart';
...
class MatrixScanScreen extends StatefulWidget {
  ...
  @override
  createState() => _MatrixScanScreenState();
}
...
class _MatrixScanScreenState extends State<MatrixScanScreen>
  ...
  final Map<int, ProductBubble?> _trackedBarcodes = {};
  ...
  void initState() {
    super.initState();
    _context = DataCaptureContext.forLicenseKey(widget.licenseKey);
    ...
    var basicOverlay = BarcodeTrackingBasicOverlay.withBarcodeTrackingForViewWithStyle(
        _barcodeTracking, _captureView, BarcodeTrackingBasicOverlayStyle.dot);
    _captureView.addOverlay(basicOverlay);
