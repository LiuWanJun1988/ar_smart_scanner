...
class ProductBubbleState extends State<ProductBubble> {
  ...
  void initState() {
    ...
    _barcodeData =
        Text(widget.barcodeData, textDirection: TextDirection.ltr, style: const TextStyle(fontSize: 12, color: Colors.black));
  }
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Image(image: AssetImage("assets/images/stock_count.png")),
          ),
          Expanded(
              child: Center(
